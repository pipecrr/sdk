...
function preloadFlex(){
    ...
    if(sdk_debug){
        ...
        loadCss('/_content/Siesa.SDK.Frontend/flex/static/css/2.css?v=20230518');
        loadCss('/_content/Siesa.SDK.Frontend/flex/static/css/main.css?v=20230518');

        loadScript('/_content/Siesa.SDK.Frontend/flex/FlexComponent.js?v=20230518');
        loadScript("/_content/Siesa.SDK.Frontend/flex/static/js/2.chunk.js?v=20230518");
        loadScript("/_content/Siesa.SDK.Frontend/flex/static/js/main.chunk.js?v=20230518");
        loadScript("/_content/Siesa.SDK.Frontend/flex/static/js/runtime-main.js?v=20230518");
    }

...
namespace Siesa.SDK.Frontend.Tests
{
    public class EvaluatorTests
    {
        ...
        private async Task TestDynamicMethod(bool useRoslyn)
        {
            ...
            testCases.Add("MyDynamicMethod(MyListProperty[0])", "Hello");
            ...
            testCases.Add("MyDynamicMethod(Parent.MyListProperty[2])", "From");
            ...
            testCases.Add("MyDynamicMethod(Parent.Parent.MyListProperty[3])", "Parent");
